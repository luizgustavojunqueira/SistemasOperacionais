...
static void shell_fire(void) { fire(); }

static void shell_clearscreen(void) { clearShellScreen(); }
...
static void shell_ls(void) {
  ...
  // Code/pseudocode you can use somewhere to get the same ls output as the
  // tests
  //   writeStr("Name");
